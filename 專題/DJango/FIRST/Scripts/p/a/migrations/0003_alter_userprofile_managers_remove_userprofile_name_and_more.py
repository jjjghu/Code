# Generated by Django 4.2.7 on 2023-12-01 04:24
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('a', '0002_rename_height_userprofile_password_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='userprofile',
            name='username',
            field=models.CharField(default='defaultName', error_messages={'unique': 'A user with that username already exists.'}, help_text='Required. 150 characters or fewer. Letters, digits and @/./+/-/_ only.', max_length=150, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='username'),
